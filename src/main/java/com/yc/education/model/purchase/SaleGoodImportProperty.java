 ...
 * @Version 1.0
 */
public class SaleGoodImportProperty {
    ...
    public SaleGoodImportProperty() {
    }

    public SaleGoodImportProperty(boolean checked, long id, String proisnum, int sort, String proname, int pronum, double proprice) {
        setChecked(checked);
        setId(id);
