 ...
 * @Version 1.0
 */
public class QuotationImportProperty {
    ...
    public QuotationImportProperty() {
    }

    public QuotationImportProperty(boolean checked, long id, String proisnum, int sort, String proname, int pronum, double proprice) {
        setChecked(checked);
        setId(id);
