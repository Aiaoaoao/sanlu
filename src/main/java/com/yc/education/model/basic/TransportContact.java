...
public class TransportContact {
    ...
    public TransportContact(long id,Integer keycontact, String uname, String udepartment, String ujob, String uphone, String ufax, String umobile, String uemail, String uremarks) {
        this.id=id;
    ...
    public TransportContact(long id,Integer keycontact, String uname, String udepartment, String ujob, String uphone, String ufax, String umobile, String uemail, String uremarks, Integer ispoint, Long supplierid) {
        this.id=id;
        this.keycontact = keycontact;
        this.uname = uname;
        this.udepartment = udepartment;
